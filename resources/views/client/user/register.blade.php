...
<body>
    ...
    <section class="hero-section">
                ...
                <div class="col-xl-4 col-lg-5 offset-xl-2 offset-lg-1">
                    <div class="booking-form">
                        ...
                        <div class="check-date">
                                ...
                                <p style="color:#CB4154">{{ $errors->first('hoten') }}</p>
                            </div>
                            <div class="check-date">
                                <label for="username" style="font-size:20px ;">Tên đăng nhập:</label>
                                <input value="{{old('username')}}" style="border-radius: 10px; font-size:15px" type="text" name="username" id="username"/>
                                <p style="color:#CB4154">{{ $errors->first('username') }}</p>
                            </div>
                            <div class="check-date">
                                <label for="email" style="font-size:20px ;">Email:</label>
                                <input value="{{old('email')}}" style="border-radius: 10px; font-size:15px" type="text" name="email"  id="email"/>
        ...
        <div class="hero-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="Image/hero/hero-1.jpg"></div>
            <div class="hs-item set-bg" data-setbg="Image/hero/hero-2.jpg"></div>
            <div class="hs-item set-bg" data-setbg="Image/hero/hero-3.jpg"></div>
        </div>
    </section>
    <!-- Hero Section End -->
